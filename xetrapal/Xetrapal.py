...
>>>>>>> bfedd53f177f24161be73b77983bb19c6d416b9a
...
=======
	...
	def login_fb(self):
		...
		self.karta.tell({"msg":"run","func":fbkarmas.fb_login,"args":(self.astras['fbbrowser'],get_section(self.config,"Facebook")),"kwargs":{"logger":self.logger}})
